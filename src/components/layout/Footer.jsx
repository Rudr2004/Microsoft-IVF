        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-6">
          ...
          <div className="lg:col-span-2 pr-0 lg:pr-12">
            <Link to="/" className="inline-flex mb-5 group">
              <img src="/MicroSort-logo.png" alt="MicroSort logo" className="h-10 w-auto transition-transform duration-300 group-hover:scale-105 object-contain brightness-0 invert" />
            </Link>
