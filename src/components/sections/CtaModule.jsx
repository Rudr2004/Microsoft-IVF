    ...
    <section className="py-16 md:py-24 bg-surface border-t border-border relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-10">
          <Button 
            href="/contact" 
            className="w-full sm:w-auto justify-center text-sm group px-8 py-3.5 sm:px-10"
          >
          ...
          <Button 
            href="/contact" 
            variant="outline" 
            className="w-full sm:w-auto justify-center text-sm px-8 py-3.5 sm:px-10"
          >
            <MessageSquare size={16} className="mr-2 shrink-0" />
            <span className="text-center">Talk to a Coordinator</span>
          </Button>
        </div>
